...
#################################
#curve stuff, 
#mostly from https://github.com/byterubpay/bitbyterub/blob/1b8a68f6c1abcf481652c2cfd87300a128e3eb32/src/crypto/crypto-ops.c
...
###################################################
#CryptoNote Things
#Mainly from https://github.com/byterubpay/bitbyterub/blob/1b8a68f6c1abcf481652c2cfd87300a128e3eb32/src/crypto/crypto.cpp
###################################################
...
def check_ring_signature(prefix, key_image, pubs, pubs_count, sigr, sigc):
    #from https://github.com/byterubpay/bitbyterub/blob/6a70de32bf872d97f9eebc7564f1ee41ff149c36/src/crypto/crypto.cpp
