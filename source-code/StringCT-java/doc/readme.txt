...
gcc -fPIC -c how_byterub_hodl_jni_CryptoOpsUtil.c crypto-ops.c crypto-ops-data.c -I /<path to jdk>/include/<OS>/ -I /<path to jdk>/include

gcc -dynamiclib -o libcryptoopsutil.jnilib how_byterub_hodl_jni_CryptoOpsUtil.o crypto-ops.o crypto-ops-data.o -framework JavaVM
